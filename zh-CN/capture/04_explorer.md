...
除了主内容区域操作外，Reqable还提供了**工作台**侧边栏用于辅助操作。点击侧边栏的第一个图标，可以打开工作台面板。工作台中包含五个部分：[收藏](#favorite)、[书签](#bookmark)、[设备](#device)、[应用程序](#application)、[域名](#domain)和[结构树](#structure)。
...
在底部搜索输入框可以对[设备](#device)、[域名](#domain)和[应用程序](#application)进行快速筛选。
