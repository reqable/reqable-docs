...
There are some ways to create a mirror rule:
...
- Use CONNECT address, the CONNECT address generally refers to the url address, such as `reqable.com:80`. This value is generally the same as the SNI.
...
- Use CONNECT address, the CONNECT address generally refers to the url address, such as `reqable.com:80`. This value is generally the same as the CN.
