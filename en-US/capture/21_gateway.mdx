...
Gateway is one of Reqable's core debugging features. Despite the name, it is not a network gateway in the networking sense—it refers to Reqable's traffic-control feature.
